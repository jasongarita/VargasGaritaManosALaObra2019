...
public class InterfaceEmployee {
    ...
    public VBox getmIAddEmployee() {
        ...
        lBLastName.setStyle("-fx-text-fill: lightgreen;" + "-fx-background-color:gray ");
        ...
        lBID.setStyle("-fx-text-fill: lightgreen;" + "-fx-background-color:gray ");
        ...
        lBCode.setStyle("-fx-text-fill: lightgreen;" + "-fx-background-color:gray ");
        ...
        lBHoursE.setStyle("-fx-text-fill: lightgreen;" + "-fx-background-color:gray ");
        ...
        lBHours.setStyle("-fx-text-fill: lightgreen;" + "-fx-background-color:gray ");
    ...
    public VBox getModificar() {
        ...
        lb_Modify.setStyle("-fx-text-fill: lightgreen;" + "-fx-background-color:gray");
        lb_Modify.setFont(Garamond2);
        lb_NewName.setStyle("-fx-text-fill: black;" + "-fx-background-color:gray");
